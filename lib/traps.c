...
/*** exercise 4.11 ***/
void
page_fault_handler(struct Trapframe *tf)    //tf is the KERNEL_SP actually ? 
{
    ...
    //Although value of sp(user stack's address) in the kernel_sp has been changed to UXSTACKTOP,
    //but we store the old value in the PgTranFrame
    //then PgTrapFrame was saved in UXSTACKTOP as well 
