...
#define SYS_get_thread_id    ((__SYSCALL_BASE ) + (18 ) )
#define SYS_sem_init        ((__SYSCALL_BASE ) + (19 ) )
...
#define SYS_thread_join     ((__SYSCALL_BASE ) + (25 ) )
#define SYS_printf          ((__SYSCALL_BASE ) + (26 ) )
#endif
